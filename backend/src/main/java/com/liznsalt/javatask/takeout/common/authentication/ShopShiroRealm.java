...
@Service("shopShiroRealm")
public class ShopShiroRealm extends AuthorizingRealm {
    ...
    @Autowired
    public void setUserService(ShopService userService) {
        this.shopService = userService;
    }
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        Shop user = shopService.queryShopByName(username);
        SimpleAuthorizationInfo simpleAuthorizationInfo = new SimpleAuthorizationInfo();
        // TODO:
        simpleAuthorizationInfo.addRole("Shop");
